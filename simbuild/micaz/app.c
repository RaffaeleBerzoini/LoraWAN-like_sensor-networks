...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b2f458, const void *arg_0xb7b2f5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7ae08c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb798a840), 
int (*key_eq_fn)(void *arg_0xb798ac88, void *arg_0xb798ae00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78599b8, int arg_0xb7859b10);
static double RandomUniform(void );
...
typedef TMilli NodesC$Timer0$precision_tag;
typedef TMilli NodesC$Timer1$precision_tag;
typedef TMilli NodesC$Timer2$precision_tag;
...
static void NodesC$Timer0$fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void NodesC$AMControl$startDone(error_t error);
#line 138
static void NodesC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void NodesC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void NodesC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodesC$Timer1$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodesC$Timer2$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodesC$Timer0$startPeriodicAt(uint32_t t0, uint32_t dt);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t NodesC$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t NodesC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void NodesC$Timer1$startOneShot(uint32_t dt);
#line 73
static void NodesC$Timer2$startOneShot(uint32_t dt);
# 35 "NodesC.nc"
message_t NodesC$packet[1000];
node_msg_t NodesC$last_msg_sent[1000];

uint16_t NodesC$time_delays[1000][2];
uint16_t NodesC$last_MID_received[1000][5];
uint16_t NodesC$start_timer[1000][5];
int NodesC$current_msg_id[1000];

int NodesC$sockfd[1000];
int NodesC$connection[1000];
int NodesC$sent[1000];
struct sockaddr_in NodesC$servaddr[1000];

bool NodesC$locked[1000];
bool NodesC$ack_received[1000];

static bool NodesC$actual_send(uint16_t address, message_t *packet);


static inline void NodesC$Timer0$fired(void );
#line 96
static inline void NodesC$Timer2$fired(void );
#line 122
static inline void NodesC$Timer1$fired(void );
...
#line 297
static inline void NodesC$AMSend$sendDone(message_t *bufPtr, error_t error);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void NodesC$Timer1$startOneShot(uint32_t dt){
#line 73
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * NodesC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 188
    {
      ...
      if (TOS_NODE_ID <= 5) {
          if (__nesc_ntoh_int8(msg->type.nxdata) == ACK && __nesc_ntoh_int8(msg->sender.nxdata) == TOS_NODE_ID && __nesc_ntoh_uint8(msg->id.nxdata) == __nesc_ntoh_uint8(NodesC$last_msg_sent[sim_node()].id.nxdata)) {
              sim_log_debug(157U, "radio_rec", "received ACK message at %s with:\n\t\tsender: %d\n\t\tid: %d\n\t\tvalue: %d\n", sim_time_string(), __nesc_ntoh_int8(msg->sender.nxdata), __nesc_ntoh_uint8(msg->id.nxdata), __nesc_ntoh_uint8(msg->value.nxdata));
              NodesC$ack_received[sim_node()] = TRUE;
            }
        }
      else {
        ...
        if (TOS_NODE_ID == 6 || TOS_NODE_ID == 7) 
          {
            switch (__nesc_ntoh_int8(msg->type.nxdata)) {
                ...
                __nesc_hton_uint8(msg_packet->delimiter1.nxdata, __nesc_ntoh_uint8(msg->delimiter1.nxdata));
                __nesc_hton_int8(msg_packet->delimiter2.nxdata, __nesc_ntoh_int8(msg->delimiter2.nxdata));

                NodesC$Timer1$startOneShot(NodesC$time_delays[sim_node()][TOS_NODE_ID - 6]);
                break;
                case ACK: 
                  sim_log_debug(159U, "radio_rec", "received ACK message at %s with:\n\t\tsender: %d\n\t\tid: %d\n\t\tvalue: %d\n", sim_time_string(), __nesc_ntoh_int8(msg->sender.nxdata), __nesc_ntoh_uint8(msg->id.nxdata), __nesc_ntoh_uint8(msg->value.nxdata));
                __nesc_hton_uint8(msg_packet->value.nxdata, __nesc_ntoh_uint8(msg->value.nxdata));
                __nesc_hton_int8(msg_packet->type.nxdata, __nesc_ntoh_int8(msg->type.nxdata));
                __nesc_hton_int8(msg_packet->sender.nxdata, __nesc_ntoh_int8(msg->sender.nxdata));
                __nesc_hton_uint8(msg_packet->id.nxdata, __nesc_ntoh_uint8(msg->id.nxdata));
          ...
          if (TOS_NODE_ID == 8) 
            {
              if (__nesc_ntoh_int8(msg->type.nxdata) == ACK) {
#line 232
                  return bufPtr;
                }
#line 233
              sim_log_debug(160U, "radio_rec", "received DATA message at %s with:\n\t\tsender: %d\n\t\tid: %d\n\t\tvalue: %d\n", sim_time_string(), __nesc_ntoh_int8(msg->sender.nxdata), __nesc_ntoh_uint8(msg->id.nxdata), __nesc_ntoh_uint8(msg->value.nxdata));

              if (__nesc_ntoh_uint8(msg->id.nxdata) == NodesC$last_MID_received[sim_node()][__nesc_ntoh_int8(msg->sender.nxdata) - 1]) {
                  sim_log_debug(161U, "radio_rec", "Ignoring duplicated message, sending ACK s:  %d, id:  %d, v: %d\n", __nesc_ntoh_int8(msg->sender.nxdata), __nesc_ntoh_uint8(msg->id.nxdata), __nesc_ntoh_uint8(msg->value.nxdata));

                  __nesc_hton_uint8(msg_packet->value.nxdata, __nesc_ntoh_uint8(msg->value.nxdata));
                  __nesc_hton_int8(msg_packet->type.nxdata, ACK);
                  __nesc_hton_int8(msg_packet->sender.nxdata, __nesc_ntoh_int8(msg->sender.nxdata));
                  __nesc_hton_uint8(msg_packet->id.nxdata, __nesc_ntoh_uint8(msg->id.nxdata));
                  __nesc_hton_uint8(msg_packet->delimiter1.nxdata, __nesc_ntoh_uint8(msg->delimiter1.nxdata));
                  __nesc_hton_int8(msg_packet->delimiter2.nxdata, __nesc_ntoh_int8(msg->delimiter2.nxdata));
              ...
              NodesC$last_MID_received[sim_node()][__nesc_ntoh_int8(msg->sender.nxdata) - 1] = __nesc_ntoh_uint8(msg->id.nxdata);
              __nesc_hton_uint8(msg_packet->value.nxdata, __nesc_ntoh_uint8(msg->value.nxdata));
              __nesc_hton_int8(msg_packet->type.nxdata, ACK);
              __nesc_hton_int8(msg_packet->sender.nxdata, __nesc_ntoh_int8(msg->sender.nxdata));
              __nesc_hton_uint8(msg_packet->id.nxdata, __nesc_ntoh_uint8(msg->id.nxdata));
              ...
              NodesC$sockfd[sim_node()] = socket(2, SOCK_STREAM, 0);
              if (NodesC$sockfd[sim_node()] == -1) 
                {
                  sim_log_debug(162U, "error", "Socket creation failed!\n");
                  return;
                }
              NodesC$servaddr[sim_node()].sin_family = 2;
              NodesC$servaddr[sim_node()].sin_addr.s_addr = inet_addr("127.0.0.1");
              NodesC$servaddr[sim_node()].sin_port = htons(2409);

              sim_log_debug(163U, "radio_send", "connecting socket...\n");
              NodesC$connection[sim_node()] = connect(NodesC$sockfd[sim_node()], (struct sockaddr *)&NodesC$servaddr[sim_node()], sizeof NodesC$servaddr[sim_node()]);
              if (NodesC$connection[sim_node()] != 0) 
                {
                  sim_log_debug(164U, "error", "Connection failed! Error: %d\n", NodesC$connection[sim_node()]);
                  close(NodesC$sockfd[sim_node()]);
                  return;
                }

              sim_log_debug(165U, "radio_send", "sending message...\n");
              NodesC$sent[sim_node()] = send(NodesC$sockfd[sim_node()], msg, sizeof(node_msg_t ), 0);
              sim_log_debug(166U, "error", "Sent bytes: %d\n", NodesC$sent[sim_node()]);
              if (NodesC$sent[sim_node()] == -1) 
                {
                  sim_log_debug(167U, "error", "Failed to send message! Error: %d\n", NodesC$sent[sim_node()]);
                  return;
                }
              close(NodesC$sockfd[sim_node()]);
            }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb75fcac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb75fcac8) {
#line 78
    case 10:
#line 78
      __nesc_result = NodesC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb75fcac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 53
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73b72b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73b72b0, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 10);
  return /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t NodesC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb75fc108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb75fc108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb75fa178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb75fa178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t NodesC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 114 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void NodesC$Timer0$startPeriodicAt(uint32_t t0, uint32_t dt){
#line 114
...
{
  if (err == SUCCESS) {
      sim_log_debug(155U, "radio", "Radio on node %d!\n", TOS_NODE_ID);
      if (TOS_NODE_ID <= 5) 
        {
          NodesC$Timer0$startPeriodicAt(NodesC$start_timer[sim_node()][TOS_NODE_ID], 2000);
        }
    }
  else {
      sim_log_error(156U, "radio", "Radio failed to start, retrying.\n");
...
#line 113
  NodesC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  NodesC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  NodesC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73b98a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73b98a8) {
#line 100
    case 0U:
#line 100
      /*NodesAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73b98a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77b5650){
#line 75
  switch (arg_0xb77b5650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77b5650);
#line 75
      break;
#line 75
    }
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t NodesC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 54
{
  ...
  if (NodesC$locked[sim_node()]) {
      return;
    }
  else {
      if (NodesC$ack_received[sim_node()]) {
...
#line 66
          ...
          __nesc_hton_uint8(msg->value.nxdata, NodesC$Random$rand16() % 50);
          __nesc_hton_int8(msg->type.nxdata, DATA);
          __nesc_hton_int8(msg->sender.nxdata, TOS_NODE_ID);
          __nesc_hton_uint8(msg->id.nxdata, NodesC$current_msg_id[sim_node()]);
          __nesc_hton_uint8(msg->delimiter1.nxdata, 10);
          __nesc_hton_int8(msg->delimiter2.nxdata, 10);
          NodesC$current_msg_id[sim_node()]++;

          NodesC$actual_send(AM_BROADCAST_ADDR, &NodesC$packet[sim_node()]);
          NodesC$ack_received[sim_node()] = FALSE;


          NodesC$Timer2$startOneShot(1000);

          __nesc_hton_uint8(NodesC$last_msg_sent[sim_node()].value.nxdata, __nesc_ntoh_uint8(msg->value.nxdata));
          __nesc_hton_int8(NodesC$last_msg_sent[sim_node()].type.nxdata, __nesc_ntoh_int8(msg->type.nxdata));
          __nesc_hton_int8(NodesC$last_msg_sent[sim_node()].sender.nxdata, __nesc_ntoh_int8(msg->sender.nxdata));
          __nesc_hton_uint8(NodesC$last_msg_sent[sim_node()].id.nxdata, __nesc_ntoh_uint8(msg->id.nxdata));
          __nesc_hton_uint8(NodesC$last_msg_sent[sim_node()].delimiter1.nxdata, __nesc_ntoh_uint8(msg->delimiter1.nxdata));
          __nesc_hton_int8(NodesC$last_msg_sent[sim_node()].delimiter2.nxdata, __nesc_ntoh_int8(msg->delimiter2.nxdata));
        }
    }
  return;
}
...
#line 102
      if (msg == (void *)0) {
          sim_log_error(150U, "radio_send", "unable to allocate message memory\n");
          return;
        }
      sim_log_debug(151U, "radio_send", "RE-sent DATA message at %s with:\n\t\tsender: %d\n\t\tid: %d\n\t\tvalue: %d\n", sim_time_string(), __nesc_ntoh_int8(msg->sender.nxdata), __nesc_ntoh_uint8(msg->id.nxdata), __nesc_ntoh_uint8(msg->value.nxdata));
      __nesc_hton_uint8(msg->value.nxdata, __nesc_ntoh_uint8(NodesC$last_msg_sent[sim_node()].value.nxdata));
      __nesc_hton_int8(msg->type.nxdata, __nesc_ntoh_int8(NodesC$last_msg_sent[sim_node()].type.nxdata));
      __nesc_hton_int8(msg->sender.nxdata, __nesc_ntoh_int8(NodesC$last_msg_sent[sim_node()].sender.nxdata));
      __nesc_hton_uint8(msg->id.nxdata, __nesc_ntoh_uint8(NodesC$last_msg_sent[sim_node()].id.nxdata));
      __nesc_hton_uint8(msg->delimiter1.nxdata, __nesc_ntoh_uint8(NodesC$last_msg_sent[sim_node()].delimiter1.nxdata));
      __nesc_hton_int8(msg->delimiter2.nxdata, __nesc_ntoh_int8(NodesC$last_msg_sent[sim_node()].delimiter2.nxdata));
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb72393a8){
#line 83
  switch (arg_0xb72393a8) {
#line 83
    case 0U:
#line 83
      NodesC$Timer0$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb72393a8);
#line 83
      break;
#line 83
    }
...
#line 154
{
  sim_log_debug(154U, "boot", "Node %d Application booted.\n", TOS_NODE_ID);
  NodesC$AMControl$start();
}
...
#line 131
{
  ...
  if (NodesC$AMSend$send(address, packet, sizeof(node_msg_t )) == SUCCESS) {
      switch (__nesc_ntoh_int8(msg->type.nxdata)) {
          case DATA: 
            sim_log_debug(152U, "radio_send", "sent DATA message at %s with:\n\t\tsender: %d\n\t\tid: %d\n\t\tvalue: %d\n", sim_time_string(), __nesc_ntoh_int8(msg->sender.nxdata), __nesc_ntoh_uint8(msg->id.nxdata), __nesc_ntoh_uint8(msg->value.nxdata));
          break;
          case ACK: 
            sim_log_debug(153U, "radio_send", "sent ACK message at %s with:\n\t\tsender: %d\n\t\tid: %d\n\t\tvalue: %d\n", sim_time_string(), __nesc_ntoh_int8(msg->sender.nxdata), __nesc_ntoh_uint8(msg->id.nxdata), __nesc_ntoh_uint8(msg->value.nxdata));
          break;
        }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module NodesC */
  if (!strcmp(varname, "NodesC$packet"))
  {
    *addr = (uintptr_t)&NodesC$packet[__nesc_mote];
    *size = sizeof(NodesC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$last_msg_sent"))
  {
    *addr = (uintptr_t)&NodesC$last_msg_sent[__nesc_mote];
    *size = sizeof(NodesC$last_msg_sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$time_delays"))
  {
    *addr = (uintptr_t)&NodesC$time_delays[__nesc_mote];
    *size = sizeof(NodesC$time_delays[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$last_MID_received"))
  {
    *addr = (uintptr_t)&NodesC$last_MID_received[__nesc_mote];
    *size = sizeof(NodesC$last_MID_received[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$start_timer"))
  {
    *addr = (uintptr_t)&NodesC$start_timer[__nesc_mote];
    *size = sizeof(NodesC$start_timer[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$current_msg_id"))
  {
    *addr = (uintptr_t)&NodesC$current_msg_id[__nesc_mote];
    *size = sizeof(NodesC$current_msg_id[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$sockfd"))
  {
    *addr = (uintptr_t)&NodesC$sockfd[__nesc_mote];
    *size = sizeof(NodesC$sockfd[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$connection"))
  {
    *addr = (uintptr_t)&NodesC$connection[__nesc_mote];
    *size = sizeof(NodesC$connection[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$sent"))
  {
    *addr = (uintptr_t)&NodesC$sent[__nesc_mote];
    *size = sizeof(NodesC$sent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$servaddr"))
  {
    *addr = (uintptr_t)&NodesC$servaddr[__nesc_mote];
    *size = sizeof(NodesC$servaddr[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$locked"))
  {
    *addr = (uintptr_t)&NodesC$locked[__nesc_mote];
    *size = sizeof(NodesC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "NodesC$ack_received"))
  {
    *addr = (uintptr_t)&NodesC$ack_received[__nesc_mote];
    *size = sizeof(NodesC$ack_received[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&NodesC$last_msg_sent[__nesc_mote], 0, sizeof NodesC$last_msg_sent[__nesc_mote]);
  memcpy((void *)&NodesC$time_delays[__nesc_mote], (void *)&(unsigned short [2]){ 61, 173 }, sizeof NodesC$time_delays[__nesc_mote]);
  memcpy((void *)&NodesC$last_MID_received[__nesc_mote], (void *)&(unsigned short [5]){ 0, 0, 0, 0, 0 }, sizeof NodesC$last_MID_received[__nesc_mote]);
  memcpy((void *)&NodesC$start_timer[__nesc_mote], (void *)&(unsigned short [5]){ 1000, 1200, 1400, 1600, 1800 }, sizeof NodesC$start_timer[__nesc_mote]);
  NodesC$current_msg_id[__nesc_mote] = 1;
  memset((void *)&NodesC$sockfd[__nesc_mote], 0, sizeof NodesC$sockfd[__nesc_mote]);
  memset((void *)&NodesC$connection[__nesc_mote], 0, sizeof NodesC$connection[__nesc_mote]);
  memset((void *)&NodesC$sent[__nesc_mote], 0, sizeof NodesC$sent[__nesc_mote]);
  memset((void *)&NodesC$servaddr[__nesc_mote], 0, sizeof NodesC$servaddr[__nesc_mote]);
  memset((void *)&NodesC$locked[__nesc_mote], 0, sizeof NodesC$locked[__nesc_mote]);
  NodesC$ack_received[__nesc_mote] = TRUE;
