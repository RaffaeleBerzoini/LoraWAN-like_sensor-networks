...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bda458, const void *arg_0xb7bda5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b8b8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a35840), 
int (*key_eq_fn)(void *arg_0xb7a35c88, void *arg_0xb7a35e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79049b8, int arg_0xb7904b10);
static double RandomUniform(void );
...
typedef TMilli NodesC$Timer$precision_tag;
...
static void NodesC$Timer$fired(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
      ...
      if (TOS_NODE_ID == 6 || TOS_NODE_ID == 7) 
        {
          ...
          switch (__nesc_ntoh_int8(msg->type.nxdata)) {
              ...
              __nesc_hton_uint8(msg_packet->topic.nxdata, __nesc_ntoh_uint8(msg->topic.nxdata));
        ...
        if (TOS_NODE_ID == 8) 
          {
            ...
            if (NodesC$sockfd[sim_node()] == -1) 
              {
                sim_log_debug(156U, "error", "Socket creation failed!\n");
                return;
              }
            ...
            sim_log_debug(157U, "radio_send", "connecting socket...\n");
            ...
            if (NodesC$connection[sim_node()] != 0) 
              {
                sim_log_debug(158U, "error", "Connection failed! Error: %d\n", NodesC$connection[sim_node()]);
                close(NodesC$sockfd[sim_node()]);
                return;
              }

            sim_log_debug(159U, "radio_send", "sending message...\n");
            NodesC$sent[sim_node()] = send(NodesC$sockfd[sim_node()], msg, sizeof(node_msg_t ), 0);
            sim_log_debug(160U, "error", "Sent bytes: %d\n", NodesC$sent[sim_node()]);
            if (NodesC$sent[sim_node()] == -1) 
              {
                sim_log_debug(161U, "error", "Failed to send message! Error: %d\n", NodesC$sent[sim_node()]);
                return;
              }
            close(NodesC$sockfd[sim_node()]);
            sleep(16);
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76a3298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76a3298) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76a3298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb747f9f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb747f9f8, addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76b28b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76b28b0, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76a3930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76a3930, msg, payload, len);
#line 78
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb747f010, message_t * msg, error_t error){
#line 100
  switch (arg_0xb747f010) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb747f010, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7860650){
#line 75
  switch (arg_0xb7860650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7860650);
#line 75
      break;
#line 75
    }
...
#line 54
      ...
      __nesc_hton_uint8(msg->topic.nxdata, 0);
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb7302c70){
#line 83
  switch (arg_0xb7302c70) {
#line 83
    case 0U:
#line 83
      NodesC$Timer$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb7302c70);
#line 83
      break;
#line 83
    }
